...
- Written by Brendan Darrer aided by ChatGPT 5.2 --date: 27th February 2026
...
The same code as "model_g_2d_xy_safe_plus_vort__1a.py" but with commentary.

Install:
    pip3 install numpy scipy matplotlib imageio imageio[ffmpeg]

Example:
    python3 model_g_2d_xy_safe_plus_vort__1a_STEPS.py --rotseed --quiver --zlim 1.0 --vortlim 0.5
    
or just:
    python3 model_g_2d_xy_safe_plus_vort__1a_STEPS.py
